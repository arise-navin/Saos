...
// nowforge-policy: cuip-38239200-make-department-read-only-after-requested-for-is
CatalogUiPolicy({
    $id: Now.ID["cuip_38239200_make_department_read_only_after_requested_for_is"],
    shortDescription: "Make Department read‑only after Requested For is set",
